...
В проекте используются три базовых governance слоя и отдельный repo/spec handoff contour.
...
## Boundary for repo/spec execution
- `VS Code/Codex`

VS Code/Codex используется для исполнения явного change scope внутри repo.
